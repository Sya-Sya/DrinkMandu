...
namespace template.domain.Agent
{
    public class AgentDomain
    {
        public string ContactPersonIdExpiryDate;
        ...
        public string AgentCommissionType { get; set; }
        ...
        public string TemporaryAgentCountry { get; set; }
        public string TemporaryAgentProvince { get; set; }
        public string TemporaryAgentDistrict { get; set; }
        public string TemporaryAgentVDC_Muncipality { get; set; }
        ...
        public string ContactPersonIdCertificate { get; set; }
        ...
        public string TemporaryAgentStreet { get; set; }
        public string TemporaryAgentWardNo { get; set; }
        public string Fullname { get; set; }
        public string FullAddress { get; set; }
        public string IncomeSource { get; set; }
        public string ExpecetdTransactionVolume { get; set; }
        public string influencerofdigitalwallet { get; set; }
    }
}